            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="card" style="width: 16rem;">
                        ...
                        <div class="card-body">
                            <center><a href="booking.php?car=rush" class="btn btn-primary">Book Now</a></center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <center><a href="booking.php?car=ayla" class="btn btn-primary">Book Now</a></center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <center><a href="booking.php?car=brio" class="btn btn-primary">Book Now</a></center>
                        </div>
                    </div>
                </div>
            </div>

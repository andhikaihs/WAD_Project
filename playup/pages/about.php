    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7 about-img" style="background-image: url(../assets/img/aboutt.jpg);"></div>

          <div class="col-lg-7">
            <h2>Premium Renter</h2>
            <div class="our-story">
              <h4>Est 2020</h4>
              <h3>Our Story</h3>
              <p>PlayUp merupakan penyedia dan penyewa berbagai game console dan juga aksesoris gaming pc untuk kebutuhan perorangan maupun event dengan jumlah besar. Menyediakan barang yang berkualitas dan tentunya original</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Sudah dipercaya lebih dari 10,000+ customer</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Sebagai penyedia peralatan dalam event e-sport</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Memiliki cabang di seluruh kota besar di Indonesia</span></li>
              </ul>
              <p>Sudah tidak perlu ragu lagi untuk mempercayakan kebutuhan anda kepada kami.</p>

              <div class="watch-video d-flex align-items-center position-relative">
                <i class="bi bi-play-circle"></i>
                <a href="https://youtu.be/cxXvYJyBlc4" class="glightbox stretched-link">Watch Video</a>
              </div>
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="11942" data-purecounter-duration="1" class="purecounter"></span>
                <p>Happy Customers</p>
              </div>
            </div>
          </div><!-- End Stats Item -->

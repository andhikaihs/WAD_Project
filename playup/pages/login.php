                  ...
                  <div class="card-body p-5">
                    ...
                    <form action="../config/login.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-check mb-5">
                        <input class="form-check-input me-2" type="checkbox" value="Y" id="remember" name="remember">
                        <label class="form-check-label" for="remember">Remember Me</label>
                      </div>
                      
                      <div class="d-grid gap-1 col-3 mx-auto">
                        <button type="submit" class="btn btn-warning btn-block btn-lg gradient-custom-4 text-body" name="submit">Sign In</button>
                      </div>

                      <p class="text-center text-muted mt-5 mb-0">New here? 
                        <a href="../pages/register.php"class="text-body"><u>Create an Account</u></a></p>
                    </form>
